                                        ...
                                        <div class="span8 main-listing">
                                            ...
                                            <c:forEach items="${postAndPlates}" var="postAndPlate">
                                                ...
                                                <div id="pagination">
                                                    ...
                                                    <a href="/articles-list" class="btn">« 第一页</a>
                                                    <c:if test="${page.pageNum == 1}">
                                                        <a href="/articles-list?pageNum=${page.pageNum}" class="btn">« 上一页</a>
                                                    </c:if>
                                                    <c:if test="${page.pageNum > 1}">
                                                        <a href="/articles-list?pageNum=${page.pageNum-1}" class="btn">« 上一页</a>
                                                    </c:if>
                                                    <c:if test="${page.pageNum < page.maxPageNum}">
                                                        <a href="/articles-list?pageNum=${page.pageNum+1}" class="btn">下一页 »</a>
                                                    </c:if>
                                                    <c:if test="${page.pageNum == page.maxPageNum}">
                                                        <a href="/articles-list?pageNum=${page.maxPageNum}" class="btn">下一页 »</a>
                                                    </c:if>
                                                    <a href="/articles-list?pageNum=${page.maxPageNum}" class="btn">最后一页 »</a>
                                                </div>
