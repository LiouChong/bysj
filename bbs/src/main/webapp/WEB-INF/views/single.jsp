                        ...
                        <div class="container">
                                <div class="row">
                                        ...
                                        <div class="span8 page-content">
                                                        <ul class="breadcrumb">
                                                                <li><a href="/articles-list">Knowledge Base Theme</a><span class="divider">/</span></li>
                                                                <li><a href="#" title="View all posts in ${postAndPlate.plateName}">${postAndPlate.plateName}</a> <span class="divider">/</span></li>
                                                                <li class="active">${postAndPlate.title}</li>
                                                        </ul>

                                                        <article class=" type-post format-standard hentry clearfix">

                                                                <h1 class="post-title">${postAndPlate.title}</h1>
...
--%>
                                                        ...
                                                        <div class="like-btn">
                                                                ...
                                                                <span class="tags">
                                                                        <strong style="font-size: 25px; color: green;">作者:${postAndPlate.nickname} </strong>
                                                                </span>
                                                        ...
                                                        <section id="comments">
                                                                ...
                                                                <h3 id="comments-title">${postAndPlate.replyCount} Comments</h3>
                                                                        ...
                                                                        <c:forEach items="${ReplyAndUsers}" var="replyAndUser" varStatus="floor">
                                                                                ...
                                                                                <li class="comment even thread-even depth-1" id="li-comment-2">
                                                                                        <article id="comment-2">
                                                                                                ...
                                                                                                <a href="#">
                                                                                                        <img alt="" src="../user/${replyAndUser.picture}" class="avatar avatar-60 photo" height="60" width="60">
                                                                                                </a>
                                                                                                ...
                                                                                                <div class="comment-meta">
                                                                                                        ...
                                                                                                        <h5 class="author">
                                                                                                                <cite class="fn">
                                                                                                                        <a rel="external nofollow" class="url">${replyAndUser.nickname}
                                                                                                                </cite>
                                                                                                                - <a class="comment-reply-link" href="#">Reply</a>
                                                                                                                <span style="float: right">${floor.count}楼</span>
                                                                                                                &emsp;</a> <a href="" style="color: gray;">封禁</a>
                                                                                                        </h5>

                                                                                                        <p class="date">

                                                                                                                        <time datetime="2013-02-26T13:18:47+00:00">${replyAndUser.replyTime}</time> <a href="/deleteReply?replyId=${replyAndUser.id}&postId=${postAndPlate.id}&replyUserId=${replyAndUser.userId}&posterId=${postAndPlate.posterId}" style="float: right;color:red">删除</a>
                                                                ...
                                                                <div id="respond">
                                                                        ...
                                                                        <form action="/doReply" method="post" id="commentform">

                                                                                <input name="postId" value="${postAndPlate.id}" hidden>
